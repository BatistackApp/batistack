...
| Banque | Comptes, Transactions, Rapprochement. | Synchro BridgeAPI, Rapprochement Auto (IA simple). |
...
| Notes de Frais | Dépenses, TVA auto, Validation. | Workflow Validation Manager. |
...
| Comptabilité | Démarré : Logique de comptabilisation des charges Ulys. | Finaliser l'intégration complète (Journaux de vente/achat/banque, Grand Livre, Export FEC). Intégrer la logique UlysComptaService. |
